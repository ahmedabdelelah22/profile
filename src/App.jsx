...
//       label: "Phone",
//       Icon: Phone,
//       href: "tel:+201090949310",
//       value: "+20 109 094 9310",
//     },
//     {
//       id: "whatsapp",
//       label: "WhatsApp",
//       Icon: WhatsAppIcon,
//       href: "https://wa.me/201090949310",
...
//       label: "Email",
//       Icon: Mail,
//       href: "mailto:ahmedabdelelah909493@gmail.com",
//       value: "ahmedabdelelah909493@gmail.com",
//     },
//   ],
//   socials: [
//     {
...
//       label: "LinkedIn",
//       Icon: LinkedinIcon,
//       href: "https://www.linkedin.com/in/ahmed-abdelelah-771aaa412?utm_source=share_via&utm_content=profile&utm_medium=member_ios",
//       color: "#0A66C2",
//     },
//     {
//       id: "instagram",
//       label: "Instagram",
//       Icon: InstagramIcon,
//       href: "https://instagram.com/ahmed.devhttps://www.instagram.com/a7med.abdelelah?igsh=MTFrdmZjYjZwd3I4ag%3D%3D&utm_source=qr",
//       color: "#E4405F",
//     },
//     {
//       id: "github",
...
//       label: "X",
//       Icon: XIcon,
//       href: "https://x.com/a7medabdelelah?s=11",
//       color: "#E7E7E7",
//     },
//     {
//       id: "whatsapp",
...
//       label: "Portfolio",
//       Icon: PortfolioIcon,
//       href: "https://my-portfolio-after-update-2.vercel.app/",
//       color: "#D4AF6A",
//     },
//     {
//       id: "facebook",
//       label: "Facebook",
//       Icon: FacebookIcon,
//       href: "https://www.facebook.com/share/199yVMahU8/?mibextid=wwXIfr",
//       color: "#1877F2",
//     },
//     {
//       id: "email",
...
//       label: "Resume",
//       Icon: File,
//       href: "https://my-portfolio-2-update.vercel.app/Ahmed_Abdelelah_CV.pdf",
//       value: "Ahmed_Abdelelah_CV.pdf",
//     },
//   ],
//   payments: [
//     {
...
//   <span style={{ color: C.gold }}>Find me on</span>
//   <div style={{ flex: 1, height: 1, background: C.divider }} />
// </div>
...
// >
//   <div style={{ flex: 1, height: 1, background: C.divider }} />
//   <span style={{ color: C.gold }}>Pay me</span>
//   <div style={{ flex: 1, height: 1, background: C.divider }} />
// </div>
...
//                       borderRadius: 10,
//                       background:
//                         copied === p.id ? `${p.gradient[0]}22` : C.pill,
...
import { useState, useEffect } from "react";
import {
  Phone, Mail, Smartphone, MapPin,
  Copy, Check, Share2, ArrowUpRight,
} from "lucide-react";
...
function PortfolioIcon({ size = 20, color = "currentColor" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="10" />
      <line x1="2" y1="12" x2="22" y2="12" />
...
function FileIcon({ size = 20, color = "currentColor" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
const PROFILE = {
  ...
  rawEmail: "ahmedabdelelah909493@gmail.com",
  cvUrl: "https://my-portfolio-2-update.vercel.app/Ahmed_Abdelelah_CV.pdf",
  profileUrl: "https://profile-inky-eight-50.vercel.app/",
  contacts: [
  ...
  socials: [
    { id:"phone",     label:"Phone",     Icon:Phone,        href:"tel:+201090949310" },
    { id:"linkedin",  label:"LinkedIn",  Icon:LinkedinIcon, href:"https://www.linkedin.com/in/ahmed-abdelelah-771aaa412" },
    { id:"instagram", label:"Instagram", Icon:InstagramIcon,href:"https://www.instagram.com/a7med.abdelelah" },
    { id:"github",    label:"GitHub",    Icon:GithubIcon,   href:"https://github.com/ahmedabdelelah22" },
    { id:"x",         label:"X",         Icon:XIcon,        href:"https://x.com/a7medabdelelah" },
    { id:"whatsapp",  label:"WhatsApp",  Icon:WhatsAppIcon, href:"https://wa.me/201090949310" },
    { id:"portfolio", label:"Portfolio", Icon:PortfolioIcon,href:"https://my-portfolio-after-update-2.vercel.app/" },
    { id:"facebook",  label:"Facebook",  Icon:FacebookIcon, href:"https://www.facebook.com/share/199yVMahU8/" },
    { id:"email",     label:"Email",     Icon:Mail,         href:"mailto:ahmedabdelelah909493@gmail.com" },
    { id:"resume",    label:"Resume",    Icon:FileIcon,     href:"https://my-portfolio-2-update.vercel.app/Ahmed_Abdelelah_CV.pdf" },
  ],
  payments: [
    {
      id: "instapay",
      label: "InstaPay",
      sub: "Send money instantly",
      handle: "ahmedabdelelah909493@instapay",
      copyValue: "ahmedabdelelah909493@instapay",
      link: "https://ipn.eg/S/ahmedabdelelah909493/instapay/4gnHsD",
      icon: "instapay",
      // brand gradient: InstaPay Egypt purple→pink
      g1: "#7B2FBE", g2: "#E91E8C",
      badge: "Instant",
    },
    {
...
const C = {
  ...
  surface:    "#111114",
  card:       "#161619",
  cardBorder: "rgba(212,175,106,0.12)",
  divider:    "rgba(255,255,255,0.055)",
  gold:       "#D4AF6A",
  goldDim:    "rgba(212,175,106,0.25)",
  goldBg:     "rgba(212,175,106,0.07)",
  text:       "#F4F1EB",
  textSub:    "#9A9590",
  textMuted:  "#5A5653",
    ...
    <>
      <style>{`
        @keyframes tpulse {
          ...
          65% { transform:scale(1.36); opacity:0; }
          100%{ transform:scale(1.36); opacity:0; }
        }
        .tr  { position:absolute;inset:0;border-radius:50%;border:1px solid ${C.gold};animation:tpulse 3s cubic-bezier(.16,1,.3,1) infinite; }
        .tr2 { animation-delay:1.1s; }
      `}</style>
      <div className="tr"/><div className="tr tr2"/>
    </>
  );
}
...
function GoldDivider({ label }) {
  return (
    <div style={{ display:"flex", alignItems:"center", gap:12, margin:"8px 0 16px" }}>
      <div style={{ flex:1, height:"0.5px", background:`linear-gradient(to right, transparent, ${C.divider})` }}/>
      <span style={{ fontFamily:"'Inter',sans-serif", fontSize:10, fontWeight:700, letterSpacing:"0.14em", textTransform:"uppercase", color:C.gold, opacity:0.7 }}>
        {label}
      </span>
      <div style={{ flex:1, height:"0.5px", background:`linear-gradient(to left, transparent, ${C.divider})` }}/>
    </div>
  );
}

// ─── Payment card ──────────────────────────────────────────────────────────
function PaymentCard({ p, copied, shared, onCopy, onShare, onOpen }) {
  const isCopied = copied === p.id;
  const isShared = shared === p.id;

  return (
    <div style={{ background:C.card, borderRadius:14, border:`1px solid rgba(255,255,255,0.07)`, overflow:"hidden" }}>
      <div style={{ height:2, background:`linear-gradient(90deg,${p.g1},${p.g2})` }}/>

      <div style={{ display:"flex", alignItems:"center", gap:12, padding:"11px 14px" }}>
        {/* Logo */}
        <div style={{ width:40, height:40, borderRadius:9, flexShrink:0, overflow:"hidden", background:"#fff", display:"flex", alignItems:"center", justifyContent:"center" }}>
          <img src={`./${p.icon}.jpeg`} alt={p.label} width={30} height={30}/>
        </div>

        {/* Label + handle */}
        <div style={{ flex:1, minWidth:0 }}>
          <div style={{ display:"flex", alignItems:"center", gap:5, marginBottom:2 }}>
            <span style={{ fontFamily:"'Inter',sans-serif", fontSize:13, fontWeight:700, color:C.text }}>{p.label}</span>
            <span style={{ fontSize:8, fontWeight:700, letterSpacing:"0.06em", textTransform:"uppercase", color:p.g1, background:`${p.g1}16`, border:`1px solid ${p.g1}28`, padding:"1px 5px", borderRadius:99 }}>
              {p.badge}
            </span>
          </div>
          <div style={{ fontFamily:"'Inter',sans-serif", fontSize:11, color:C.textMuted, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" ,textAlign:"start"  }}>
            {p.handle}
          </div>
        </div>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:6, flexShrink:0 }}>
          ...
          {/* COPY */}
          <button
            onClick={() => onCopy(p.id, p.copyValue)}
            title="Copy"
            style={{
              width:32, height:32, borderRadius:9,
              background: isCopied ? `${p.g1}22` : C.pill,
              border:`1px solid ${isCopied ? p.g1+"44" : C.pillBorder}`,
          ...
          >
            {isCopied
              ? <Check size={14} strokeWidth={2.5} color={p.g1}/>
              : <Copy  size={14} strokeWidth={1.8} color={C.textMuted}/>}
          </button>

          {/* SHARE */}
          <button
            onClick={() => onShare(p.id, p.link, p.label, p.handle)}
            title="Share"
            style={{
              width:32, height:32, borderRadius:9,
              background: isShared ? `${p.g1}22` : C.pill,
              border:`1px solid ${isShared ? p.g1+"44" : C.pillBorder}`,
              display:"flex", alignItems:"center", justifyContent:"center",
              cursor:"pointer", transition:"all 0.2s", flexShrink:0,
            }}
            aria-label={`Share ${p.label}`}
          >
            {isShared
              ? <Check  size={14} strokeWidth={2.5} color={p.g1}/>
              : <Share2 size={14} strokeWidth={1.8} color={C.textMuted}/>}
          </button>
          ...
          >
            <ArrowUpRight size={14} strokeWidth={2.2} color={C.textMuted}/>
          </button>
...
export default function ProfileCard() {
  ...
  const handlePayShare = async (id, link, label, handle) => {
    const payload = { title: label, text: `Pay me via ${label}: ${handle}`, url: link };
    if (navigator.share) {
      try { await navigator.share(payload); }
      catch (e) { if (e.name !== "AbortError") await navigator.clipboard?.writeText(link); }
    } else {
  ...
  const handlePayOpen = (link) => {
    window.open(link, "_blank", "noopener,noreferrer");
  };

  const shareProfile = async () => {
    if (navigator.share) {
      try { await navigator.share({ title: PROFILE.name, text: `${PROFILE.name} • ${PROFILE.role}`, url: PROFILE.profileUrl }); return; }
      catch {console.log("Share failed or was aborted, falling back to clipboard copy...") }
    }
  ...
  const handleSaveContact = () => {
    const vcard = ["BEGIN:VCARD","VERSION:3.0",`FN:${PROFILE.name}`,`TITLE:${PROFILE.role}`,`TEL;TYPE=CELL:${PROFILE.rawPhone}`,`EMAIL;TYPE=INTERNET:${PROFILE.rawEmail}`,"END:VCARD"].join("\n");
    const blob = new Blob([vcard],{type:"text/vcard;charset=utf-8;"});
    const url  = URL.createObjectURL(blob);
    const a    = Object.assign(document.createElement("a"),{href:url,download:`${PROFILE.name.replace(/\s+/g,"_")}.vcf`});
    document.body.appendChild(a); a.click(); document.body.removeChild(a); URL.revokeObjectURL(url);
  };

  return (
    <main style={{ minHeight:"100vh", background:C.bg, display:"flex", justifyContent:"center", fontFamily:"'Inter',sans-serif" }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@500;600;700&family=Inter:wght@400;500;600;700&display=swap');
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ::-webkit-scrollbar{display:none;}
        body{background:${C.bg};}
        @keyframes spulse{0%,100%{transform:scale(1);opacity:.7;}50%{transform:scale(1.6);opacity:0;}}
        .sring{position:absolute;inset:0;border-radius:50%;background:${C.green};animation:spulse 2s ease-in-out infinite;}
        .soc{transition:all .2s cubic-bezier(.16,1,.3,1);}
        .soc:hover{transform:translateY(-3px) scale(1.08);border-color:${C.gold} !important;}
        .crow{transition:background .15s;}
        .crow:hover{background:rgba(255,255,255,0.025);}
        .sbtn{transition:background .2s;}
        .sbtn:hover{background:#E9C991 !important;}
        .shbtn{transition:all .2s;}
        .shbtn:hover{border-color:${C.gold} !important;}
        .pay-action{transition:opacity .15s;}
        .pay-action:hover{opacity:.8;}
      `}</style>

      <div style={{ width:"100%", maxWidth:400, padding:"0 0 56px" }}>

        {/* Top gold stripe */}
        <div style={{ height:3, background:`linear-gradient(90deg,transparent,${C.gold},transparent)` }}/>

        {/* ─── HEADER ─── */}
        <header style={{ padding:"36px 24px 20px", textAlign:"center" }}>
          {/* Avatar */}
          <div style={{ width:100,height:100,margin:"0 auto 20px",position:"relative" }}>
            {mounted && <TapRing/>}
            <div style={{
              width:"100%",height:"100%",borderRadius:"50%",
              background:"linear-gradient(135deg,#221D16,#0A0A0B)",
              border:`1px solid ${C.cardBorder}`,
              display:"flex",alignItems:"center",justifyContent:"center",
              position:"relative",zIndex:2,overflow:"hidden",
            }}>
              <img src={`./${PROFILE.photo}.png`} alt={PROFILE.name}
                style={{ width:"100%",height:"100%",objectFit:"cover" }}
                onError={e=>{e.target.style.display="none"; e.target.nextSibling.style.display="flex";}}
              />
              <span style={{
                display:"none",fontFamily:"'Space Grotesk',sans-serif",
                fontSize:32,fontWeight:600,color:C.gold,
                position:"absolute",
          ...
          <p style={{ fontFamily:"'Inter',sans-serif", fontSize:11, fontWeight:700, color:C.gold, letterSpacing:"0.1em", textTransform:"uppercase", marginBottom:12 }}>
            {PROFILE.role}
          </p>
        ...
        <div style={{ padding:"0 20px 24px" }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:8 }}>
            {PROFILE.socials.map((s,i) => (
              ...
              >
                <s.Icon size={19} color={C.textSub}/>
                <span style={{ fontFamily:"'Inter',sans-serif", fontSize:8, fontWeight:600, color:C.textMuted, letterSpacing:"0.04em", textAlign:"center", lineHeight:1 }}>
                  {s.label}
                </span>
              </a>
            ))}
          ...
          <div style={{ background:C.card, border:`1px solid ${C.cardBorder}`, borderRadius:16, overflow:"hidden" }}>
            {PROFILE.contacts.map((item, i) => (
              ...
              >
                ...
                <div style={{ flex:1, minWidth:0 }}>
                  <div style={{ fontFamily:"'Inter',sans-serif", fontSize:9.5, fontWeight:700, color:C.textMuted, textTransform:"uppercase", letterSpacing:"0.1em", marginBottom:2 }}>
                    {item.label}
                  </div>
                  <div style={{ fontFamily:"'Inter',sans-serif", fontSize:13.5, fontWeight:500, color:C.text, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>
                    {item.value}
                ...
                <ExternalLink size={13} color={C.textMuted} strokeWidth={1.8}/>
              </a>
            ))}
          </div>
        </div> */}
   ...
   <div style={{ padding:"0 20px 24px", display:"flex", gap:10 }}>
        ...
        {/* ─── FOOTER ─── */}
        <footer style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:8, padding:"0 0 8px" }}>
